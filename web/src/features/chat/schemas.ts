...
export const SessionSchema = z.object({
  ...
  order_summary: z.string().default(""),
  payment_status: z.enum(["unknown", "none", "deposit", "paid"]).default("unknown"),
  payment_notes: z.string().default(""),
  client_details_confirmed: z.boolean().default(false),
  client_details_confirmed_at: z.string().nullable().default(null),
  final_quote_amount: z.number().nullable().default(null),
  final_quote_updated_at: z.string().nullable().default(null),
  final_quote_updated_by: z.string().default(""),
  approved_quote_amounts: z.record(z.string(), z.number()).default({}),
  approved_quote_tax_modes: z.record(z.string(), z.enum(["plus", "included"])).default({}),
  approved_quote_price_modes: z.record(z.string(), z.enum(["unit", "total"])).default({}),
  approved_quote_quantities: z.record(z.string(), z.number()).default({}),
  approved_quote_notes: z.record(z.string(), z.string()).default({}),
  approved_quotes_updated_at: z.string().nullable().default(null),
  approved_quotes_updated_by: z.string().default(""),
  confirmed_quote_keys: z.array(z.string()).default([]),
  ...
  source_organization: z.string().default(""),
  source_category: z.string().default(""),
  source_deadline: z.string().default(""),
  processing_status: z.string().default(""),
...
export const SessionRowSchema = z.object({
  ...
  product_keys: z.array(z.string()).default([]),
  source_type: z.string().default(""),
  external_id: z.string().default(""),
  source_url: z.string().default(""),
  source_organization: z.string().default(""),
  source_category: z.string().default(""),
  source_deadline: z.string().default(""),
  source_published: z.string().default(""),
  source_files: z.array(z.string()).default([]),
  processing_status: z.string().default(""),
  processing_error: z.string().default(""),
  general_specs: z.object({
    delivery_location: z.string().default(""),
    delivery_days: z.number().nullable().default(null),
    payment_terms: z.string().default(""),
    offer_maintenance_days: z.number().nullable().default(null),
